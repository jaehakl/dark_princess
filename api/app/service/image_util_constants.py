...
GEN_IMAGE_CAMERA_SAMPLES ={
  ...
  "시점과_방향": {
    ...
    "three-quarter view": "정면과 측면 사이의 자연스러운 3/4 시점",
    "rear view": "뒤에서 바라보는 시점, 미스터리나 여정의 느낌을 줌",
    "over-the-shoulder shot": "한 인물의 어깨 너머로 다른 인물이나 장면을 보는 구도",
    ...
    "observer viewpoint": "감정 개입이 적은 관찰자적 시점",
  ...
  "원근법": {
    ...
    "forced perspective": "크기와 거리 착시를 이용한 과장된 원근",
    ...
    "orthographic view": "원근 왜곡이 거의 없는 평면적 투영",
  ...
  "색상_팔레트": {
    ...
    "muted colors": "채도를 낮춘 부드러운 색감",
    "desaturated colors": "색이 빠진 듯한 낮은 채도",
    "saturated colors": "채도가 높고 선명한 색감",
    "vibrant colors": "생생하고 활기 있는 색감",
    "pastel palette": "연하고 부드러운 파스텔 색감",
    "earth tones": "흙, 나무, 바위 같은 자연색 계열",
    "jewel tones": "보석처럼 깊고 진한 색감",
    "monochromatic palette": "한 가지 색 계열 중심의 색 구성",
