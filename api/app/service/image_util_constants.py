...
CUT_PROMPT_FIELDS = ("prompt_situation", "prompt_hero", "prompt_camera", "prompt_detail")
...
GEN_IMAGE_CAMERA_SAMPLES ={
  "구도": {
    "close-up": "얼굴이나 특정 사물을 크게 보여 주는 근접 구도",
    "cowboy framing": "허벅지 위까지 잡는 서부극식 인물 구도",
  ...
  "각도": {
    "eye-level view": "눈높이 시점으로 자연스럽고 현실적인 인상을 줌",
    "high-angle view": "위에서 내려다봐 피사체를 작고 약하게 보이게 함",
    "low-angle view": "아래에서 올려다봐 피사체를 강하고 위압적으로 보이게 함",
  ...
  "시점": {
    ...
    "first-person perspective": "1인칭 게임이나 체험 컷처럼 보이는 시점",
  ...
  "스타일": {
    ...
    "cinematic": "영화 컷처럼 인물, 배경, 빛, 시선 흐름, 디테일과 연출감 표현",
