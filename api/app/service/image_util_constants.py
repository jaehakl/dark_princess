...
GEN_IMAGE_CAMERA_SAMPLES = {
  ...
  "공간과_스케일": ["vast open space", "enclosed interior", "cramped space", "cavernous space", "narrow corridor", "layered environment", "dense urban setting", "quiet rural setting", "wilderness", "industrial interior", "domestic interior", "grand architecture", "ruined architecture", "cluttered environment", "minimalist environment", "lived-in environment", "monumental scale", "intimate scale"],
  "시대와_장르": ["contemporary realism", "historical drama", "period piece", "fantasy", "dark fantasy", "science fiction", "space opera", "cyberpunk", "solarpunk", "steampunk", "retrofuturism", "post-apocalyptic", "gothic", "noir", "western", "folklore", "mythic", "surreal fantasy", "cosmic horror"],
  ...
  "관습적_품질_태그_체크포인트_의존": ["high quality", "best quality", "masterpiece", "ultra-detailed"],
